	...
	<w:pPr>
		...
		<w:r>
			<w:pict>
				...
				<w:binData w:name="wordml://${img.name}" xml:space="preserve">${img.content}
</w:binData>
<v:shape id="_x0000_i1025" type="#_x0000_t75" style="width:150.25pt;height:150.25pt;mso-position-horizontal:absolute;mso-position-horizontal-relative:text;mso-position-vertical:absolute;mso-position-vertical-relative:text;mso-width-relative:page;mso-height-relative:page">
	<v:imagedata src="wordml://${img.name}" o:title="logo"/></v:shape>
	</w:pict>
	</w:r>
	<w:r>
		<w:rPr>
...
<w:sectPr wsp:rsidR="00276881" wsp:rsidSect="00991611"><w:pgSz w:w="11906" w:h="16838"/><w:pgMar w:top="1440" w:right="1800" w:bottom="1440" w:left="1800" w:header="851" w:footer="992" w:gutter="0"/><w:cols w:space="425"/><w:docGrid w:type="lines" w:line-pitch="312"/></w:sectPr></wx:sect></w:body></w:wordDocument>