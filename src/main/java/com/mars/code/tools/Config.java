...
public class Config {
	...
	public static Config loadConfig(){
		...
		pkgSetting.setJsPackage(XmlUtil.getChild(pkg, "jsPackage").getTextTrim());
		...
		for (Element e : modules) {
			...
			elePkg = XmlUtil.getChild(e, "jsPackage");
			m.setJsPackage(elePkg==null?pkgSetting.getJsPackage():elePkg.getTextTrim());
			//加载table
